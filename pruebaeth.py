...
#last2 = w32.eth.get_block('latest')
app = Flask(__name__)
...
def principal():
    ...
    trans1= w3.eth.get_transaction(last.transactions[0])
...
def infocripto(criptoname):
    ...
    #trace1 = go.Scatter(x=df2.date, y=df2.price, fill='tozeroy', line_color="gray")
    
    #layout = go.Layout(images= [dict(source= dic_imagen[criptoname], xref= "x",
    #              yref= "y",
    #              x= 0,
    #              y= 3,
    #              sizex= 2,
    ...
    #fig.add_annotation(text=titulo,
    #              xref="paper", yref="paper",
    #              x=0.9, y=0.75, showarrow=False)
    
    
    #fig=go.Figure(data=[trace1],layout=layout)
    #fig['layout'].update(margin=dict(l=0,r=0,b=0,t=0))
    #fig.update_yaxes(color="#333")
